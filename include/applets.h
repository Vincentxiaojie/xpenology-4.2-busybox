...
IF_GET_KEY_VALUE(APPLET(get_key_value, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_KILLPS(APPLET(killps, _BB_DIR_BIN, _BB_SUID_DROP))
...
IF_SYNODD(APPLET(synodd, _BB_DIR_BIN, _BB_SUID_DROP))
